  ...
  return (
    <>
      <div>
        ...
        <h6>Last Updated: May 10th 2021</h6>

        <br />

        <h2>Privacy Policy</h2>
        <p>
          Your privacy is important to us. It is Obsession Boutique By Sacoleira
          and More&#39;s policy to respect your privacy and comply with any
          applicable law and regulation regarding any personal information we
          may collect about you, including across our website,{" "}
          <a href="https://obsessionboutique.herokuapp.com">
            https://obsessionboutique.herokuapp.com
          </a>
          , and other sites we own and operate.{" "}
        </p>
        <p>
          This policy is effective as of 10 May 2021 and was last updated on 10
          May 2021.{" "}
        </p>
        ...
        <p>
          Nitza Hernandez
          <br />
          obsessionboutique2021@gmail.com{" "}
        </p>
      </div>
    </>
  );
